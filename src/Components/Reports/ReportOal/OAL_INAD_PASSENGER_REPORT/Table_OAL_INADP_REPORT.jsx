    ...
    <>
      {!processingallreports && allreports && (
        <button
          ...
          className={` ${focusReport ? 'bg-teal-500 hover:bg-red-700' : 'bg-a-dark2'} flex items-center justify-center h-10 px-2 mt-5 rounded-md text-white uppercase text-xs`}
        >
      ...
      <div className="flex gap-5">
        {!processingallreports && allreports && (
          <button
            ...
            className="  bg-red-600 hover:bg-red-700 flex items-center justify-center h-10 w-10 mt-5 rounded-md text-white uppercase text-xs"
          >
        ...
        {!processingallreports && allreports && (
          <button
            ...
            className="  bg-red-600 hover:bg-red-700 flex items-center justify-center h-10 px-2 mt-5 rounded-md text-white uppercase text-xs"
          >
            <MiniLoadingBar />
